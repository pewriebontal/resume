...
projects:
  ...
  - name: "BYAMC (Bon's Yet Another Mini C System Library)"
    ...
    details:
      ...
      - "Tested the library with various software including BJSH and Byte's Escape, conducted benchmarks showing up to 4x faster performance than *glibc* for memory operations (*memcpy*), with memory functions averaging 2.9x faster execution on small data sets and 1.8x faster on medium-sized operations."
